...
const APP_SHELL = [
  ...
  '/app-icon.svg?v=daedongmap-brand-20260922-1',
  '/assets/brand/daedongmap-logo.svg?v=daedongmap-brand-20260922-1',
  '/assets/brand/daedongmap-share-1200x630.png',
  '/assets/app-icons/daedong-app-icon-192.png',
  '/assets/app-icons/daedong-app-icon-192.png?v=daedongmap-brand-20260922-1',
  '/assets/app-icons/daedong-app-icon-192.png?v=official-brand-20260830-1',
  '/assets/app-icons/daedong-app-icon-512.png',
  '/assets/app-icons/daedong-app-icon-512.png?v=daedongmap-brand-20260922-1',
