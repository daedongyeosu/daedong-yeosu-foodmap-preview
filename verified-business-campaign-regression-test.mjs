...
assert.equal(hash({...hero,campaigns:Object.fromEntries(Object.entries(hero.campaigns).filter(([id])=>!ids.has(id)&&id!=='e66f136d0e468b6e'))}),'97ea68bbb3a1b7ac971564ad57a3b49f775db1246587f194fd15673bca8ea4c0');
