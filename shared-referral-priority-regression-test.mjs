...
assert.equal(partner.enabled,true);assert.equal(partner.storeIds.length,52);assert.equal(new Set(partner.storeIds).size,52);
assert.ok(partner.storeIds.every(id=>/^[a-f0-9]{16}$/.test(id)&&!config.deprioritizedStoreIds.includes(id)));
