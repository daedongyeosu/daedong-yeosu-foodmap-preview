...
assert.match(experience, /const anchor=fxCaptureDownstreamAnchor\(root\)/,
  '비동기 추천 결과를 실제 반영하는 순간 고객이 보던 아래쪽 콘텐츠를 기준점으로 잡아야 합니다.');
assert.match(experience, /fxRestoreDownstreamAnchor\(anchor\)/,
  '늦은 추천 삽입은 고객의 화면상 위치를 보존해야 하며 홈이나 목록 시작으로 점프하면 안 됩니다.');
