...
assert(finalExperienceSource.includes("fxRc3Script.src='rc3-fixes.js?v=selected-category-label-1-phone-route-restoration-1-multi-category-1-hamburger-priority-1';"), '전화경로 코드 캐시 버전이 갱신되지 않았습니다.');
