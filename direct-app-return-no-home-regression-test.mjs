...
assert.doesNotMatch(html, /html\.daedong-external-return-pending body>\*\{visibility:hidden!important\}/);
assert.match(html, /html\.daedong-external-return-pending body::before,[\s\S]*?z-index:99999;pointer-events:none/);
