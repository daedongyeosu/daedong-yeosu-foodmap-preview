...
const rc6HeroDataPromise=Promise.all([fetchJson('data/store-coordinates.json',{}),fetchJson('data/banner-targets.json?v=native-pages-1',{}),fetchJson('data/store-priority.json?v=former-managed-bottom-1',{}),fetchJson('data/hero-campaigns.json?v=store-campaign-standard-1-four-store-qr-1-four-store-14-plus-3-1-teum-campaign-1-three-store-campaign-1-haeinine-campaign-1',{campaigns:{},virtualStores:{}}),rc6LoadRainMode()]);
