...
check(!index.includes('콩산소 전용 여수맛지도'), '콩산소 전용 표기 제거 유지');
check(!index.includes('손수김밥 전용 여수맛지도'), '손수김밥 전용 표기 제거 유지');
...
check(app.includes('window.daedongDataApi?.catalog?.({timeoutMs: 20000})'), '가게 목록 보안 API 사용');
