...
assert(finalExperience.includes('rc3-fixes.css?v=selected-category-label-1-popup-utility-links-1'), '팝업 스타일 캐시 버전이 갱신되지 않았습니다.');
assert(finalExperience.includes('rc3-fixes.js?v=selected-category-label-1-phone-route-restoration-1-multi-category-1-hamburger-priority-1-external-app-text-1-popup-utility-links-1'), '팝업 코드 캐시 버전이 갱신되지 않았습니다.');
assert(index.includes('final-experience.js?v=selected-category-label-2-store-share-deep-link-2-phone-route-restoration-1-multi-category-1-hamburger-priority-1-external-app-text-1-popup-utility-links-1'), '최종 화면 코드 캐시 버전이 갱신되지 않았습니다.');
