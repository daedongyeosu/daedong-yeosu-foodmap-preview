...
assert.match(service, /isOfficialStorePlaceholderImage\(resolvedStoreImage\)[\s\S]*?\? matchedMenuImage[\s\S]*?: \(resolvedStoreImage \|\| matchedMenuImage\)/,
...
assert.match(index, /menu-photo-card-fallback-1/,
