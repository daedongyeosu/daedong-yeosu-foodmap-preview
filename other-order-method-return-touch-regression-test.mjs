...
assert.match(comparedLauncher, /routeKey === 'yogiyo'[\s\S]*?kakaoAndroid[\s\S]*?daedongDataApi\.yogiyoWebRoute[\s\S]*?rc2SubmitYogiyoBrowserNavigation\(yogiyoUrl\)/, '카카오 Android 요기요는 같은 카카오 방문기록의 웹 가게 상세로 이동해야 합니다.');
