...
fxRc2Script.src='rc2-fixes.js?v=location-priority-2';
 ...
 fxRc3Script.onload=()=>{
  ...
  fxRc4Script.onload=()=>{
   ...
   fxRc5Script.onload=()=>{
    ...
    const script=document.createElement('script');script.src='rc6-fixes.js?v=daily-managed-notion-banner-15a';
    script.onload=()=>{
