...
window.installDaedongTapAction?.({
 ...
 activate(target,event){
  const activate=window.daedongActivateOrderMethodsTrigger;
...
fxRc2Script.onload=()=>{
 ...
 fxRc3Script.src+='-atomic-rail-refresh-1-store-card-intent-2-return-activation-atomic-1-return-intent-cancel-1-return-early-tap-bridge-1-order-sheet-before-history-1';
