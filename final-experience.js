...
const FX_PHONE_URL='data/phone-order-runtime.json?v=phone-audit-batch-03';
...
fxRc3Style.href='rc3-fixes.css?v=phone-audit-batch-03';
...
fxRc2Script.onload=()=>{
 ...
 fxRc3Script.src='rc3-fixes.js?v=phone-audit-batch-03';
 ...
 fxRc3Script.onload=()=>{
  ...
  fxRc4Script.onload=()=>{
   ...
   fxRc5Script.onload=()=>{
    ...
    const script=document.createElement('script');script.src='rc6-fixes.js?v=location-surfaces-1';
    script.onload=()=>{
