...
fxRc2Script.onload=()=>{
 ...
 fxRc3Script.src='rc3-fixes.js?v=order-channel-safe-2';
 ...
 fxRc3Script.onload=()=>{
  ...
  fxRc4Script.onload=()=>{
   ...
   fxRc5Script.onload=()=>{
    const css=document.createElement('link');css.rel='stylesheet';css.href='rc6-fixes.css?v=bridge-gull-motion-1';document.head.append(css);
    const script=document.createElement('script');script.src='rc6-fixes.js?v=bridge-gull-motion-1';
    script.onload=()=>{
