...
fxRc2Script.onload=()=>{
 ...
 fxRc3Script.onload=()=>{
  ...
  fxRc4Script.onload=()=>{
   ...
   fxRc5Script.onload=()=>{const css=document.createElement('link');css.rel='stylesheet';css.href='rc6-fixes.css?v=neighborhood-proximity-1';document.head.append(css);const script=document.createElement('script');script.src='rc6-fixes.js?v=neighborhood-proximity-1';script.onload=()=>{fxInstallEvents();setTimeout(async()=>{await fxInitialize();await rc6Initialize();},0);};script.onerror=()=>console.error('RC6 검수 수정 레이어를 불러오지 못했습니다.');document.head.append(script);};
