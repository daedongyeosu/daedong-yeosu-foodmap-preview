...
assert.doesNotMatch(experience, /function fxCommitRailsWithoutMovingActiveList\(root,staging\)[\s\S]*section\.getBoundingClientRect\(\)\.top-before/,
  '추천 영역을 늦게 갱신할 때 고객 화면을 강제로 이동하면 안 됩니다.');
