...
const checks = [
  ...
  ['거북선 CSS·JS 캐시 버전 갱신', html.includes('turtle-ship-hero.css?v=message-colors-popup-15s-1') && html.includes('turtle-ship-hero.js?v=message-colors-popup-15s-1')],
  ...
  ['안내 팝업과 거북선 순서를 세션당 한 번만 실행', js.includes('daedongCommunityIntroPlayedV4') && js.includes('sequenceAlreadyPlayed') && js.includes('sessionStorage.setItem')],
  ['안내 팝업을 15초 동안 표시', js.includes('const INTRO_DURATION = 15000') && html.includes('15초 후 자동으로 닫힙니다.') && css.includes('community-popup-progress 15s linear')],
