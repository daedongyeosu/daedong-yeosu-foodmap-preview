...
const checks = [
  ...
  ['거북선 CSS·JS 캐시 버전 갱신', html.includes('turtle-ship-hero.css?v=12') && html.includes('turtle-ship-hero.js?v=7')],
  ...
  ['주문 버튼·배너 간격 원상복구', html.includes('class="turtle-ship-passage"') && /\.turtle-ship-passage\s*\{[\s\S]*?height:clamp\(82px,10vw,108px\)/.test(css) && /@media\(max-width:767px\)[\s\S]*?\.turtle-ship-passage\s*\{[\s\S]*?height:112px/.test(css)],
